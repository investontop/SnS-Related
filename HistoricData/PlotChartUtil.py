...
def FormatTradeDetails(platform, trade_details, trade_details_source):
    ...
    if platform == 'KITE':
        ...
        if not final_df.empty:
            # Normalize the 'symbol' column by removing anything after '-'. This is used for example PGINVIT-IF & PGINVIT-IV will be changed to GOLDBEES
        ...
        if not final_df.empty:
            ...
            file_path = os.path.join(trade_details_source, f"00-TRADE.csv")
